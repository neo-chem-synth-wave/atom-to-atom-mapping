""" The ``scripts`` directory ``map_reaction_smiles_using_rxnmapper`` script. """
...
from atom_to_atom_mapping.utility import RXNMapperAtomToAtomMappingUtility
...
if __name__ == "__main__":
    ...
    try:
        ...
        if script_arguments.reaction_smiles is not None:
            ...
            print(RXNMapperAtomToAtomMappingUtility.map_reaction_smiles(
                reaction_smiles=script_arguments.reaction_smiles,
        ...
        if (
            ...
            concat(
                objs=[
                    input_csv_file_data,
                    DataFrame(
                        data=RXNMapperAtomToAtomMappingUtility.map_reaction_smiles_strings(
