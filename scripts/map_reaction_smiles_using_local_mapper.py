""" The ``scripts`` directory ``map_reaction_smiles_using_local_mapper`` script. """
...
if __name__ == "__main__":
    ...
    try:
        ...
        if script_arguments.reaction_smiles is not None:
            ...
            print(LocalMapperAtomToAtomMappingUtility.map_reaction_smiles(
                reaction_smiles=script_arguments.reaction_smiles,
        ...
        if (
            ...
            concat(
                objs=[
                    input_csv_file_data,
                    DataFrame(
                        data=LocalMapperAtomToAtomMappingUtility.map_reaction_smiles_strings(
